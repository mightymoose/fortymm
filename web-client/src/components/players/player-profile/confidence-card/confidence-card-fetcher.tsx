 ...
 * wrong in.
 */
export function ConfidenceCardFetcher({ playerId, leagueId }: ConfidenceCardFetcherProps) {
  const { data: confidence } = useSuspenseQuery(confidenceCardQuery(playerId, leagueId))
