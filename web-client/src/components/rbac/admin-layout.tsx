  ...
  return (
    ...
    >
      <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
        {/* fg-3, not fg-muted: 12px text on bg-app needs the brighter secondary
            token to meet AA contrast (axe color-contrast, caught by the solve-
            ledger spec's admin-chrome sweep). */}
        <span style={{ fontSize: 12, color: 'var(--fg-3)', fontWeight: 500 }}>Administration</span>
        <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="var(--fg-3)" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round">
          <path d="M9 6l6 6-6 6" />
        </svg>
