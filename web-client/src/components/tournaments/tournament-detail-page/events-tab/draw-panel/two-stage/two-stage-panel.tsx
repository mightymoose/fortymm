 ...
 * 20260727): the champion, then the group stage's standings, then the knockout stage's
 ...
 * exactly this reason: a two-stage event's group table is a group table, and its placement
 ...
 * The name in it is the knockout final's winner, never the top of a group table: in this
 * format the group stage only seeds the bracket, so leading a group wins nothing. The two
 ...
 * champion. A mid-flight event (groups done, final unplayed) shows its standings and its
...
export const TwoStagePanel = ({
  ...
  <div data-testid={`two-stage-panel-${eventId}`}>
    ...
    {/* Stage one, then stage two — groups above the bracket they seeded. */}
